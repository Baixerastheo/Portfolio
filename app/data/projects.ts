...
export const projects: Project[] = [
  ...
  },
  {
    id: 2,
    title: "E-commerce",
    description: "Application e-commerce minimaliste développée avec Nuxt et Express. Plateforme de vente en ligne avec gestion de produits, panier, recherche et suivi des données utilisateur.",
    image: "/my-ecommerce.png",
    technologies: ["Vue.js", "Vite", "NestJS", "TypeScript", "Docker", "GitLab CI/CD", "Playwright"],
    category: "Full Stack",
    status: "Terminé + Ajout de features",
    whatILearned: "Ce projet m'a permis de développer une application e-commerce complète avec Nuxt et Express en TypeScript. J'ai appris à mettre en place des tests e2e (end-to-end) pour garantir la qualité de l'application, à implémenter un système de tracking de données pour analyser le comportement des utilisateurs, et à créer une architecture full-stack robuste avec TypeScript.",
    skillsGained: ["Tests e2e", "Tracking de données", "NestJS", "TypeScript", "Full-stack development"],
  },
  {
    id: 3,
